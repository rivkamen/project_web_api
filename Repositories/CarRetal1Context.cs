...
namespace Repositories;
    ...
    public partial class CarRetal1Context : DbContext
    {
        public CarRetal1Context()
        {
        }

        public CarRetal1Context(DbContextOptions<CarRetal1Context> options)
            : base(options)
        {
        }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseSqlServer("Server=srv2\\pupils;Database=CAR_RETAL1;Trusted_Connection=True;TrustServerCertificate=True", b => b.MigrationsAssembly("Repositories"));
    }
